...
using UtilitiesNet.Objetos.Correo;
using UtilitiesNet.Extensiones;
using System.IO;
using UtilitiesNet.Objetos.MessageBoxPerso;
        ...
        private void modificarToolStripMenuItem_Click(object sender, EventArgs e)
        {
            if (lVcorreos.SelectedItems.Count == 1)
            {
                if (!emails.Exists(x => x.correo == lVcorreos.SelectedItems[0].Text && x.principal == true))
                {
                    ...
                    UtilitiesNet.Controls.HerramientaTextos.frmIntroducirTexto frm = new UtilitiesNet.Controls.HerramientaTextos.frmIntroducirTexto("Correo a Modificar", "Modificar Correo");
